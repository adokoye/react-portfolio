# Adaobi C Okoye -  Portfolio with React.JS
...
I am Adaobi C Okoye, a Fullstack web developer. This portfolio contains my work so far in my coding bootcamp.
  ...
  ## Installation:
   ...
   Make sure MongoDB is installed. First, clone the repo, install dependencies with npm -i and then run ```npm start``` to run the server. 
